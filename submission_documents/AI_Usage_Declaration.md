...
**Project:** Super Mario Game (CS202 Final Project)
**Group:** 52
**Members:** 
- Member A: Nguyễn Đình Minh Huy, 25125083 (Engine & Infrastructure)
- Member B: Trần Gia Huy, 25125084 (Entities & Gameplay)

## Statement of Usage
We declare that Artificial Intelligence (AI) tools were utilized during the development of this project. The AI acted as a pair-programming assistant, contributing to the following areas:

1. **Architecture & Design:** Suggesting and refining structural design patterns (e.g., State, Observer, Factory, Singleton, Memento, Object Pool).
...
- **Claude Code** (Anthropic) — introduced in the final two weeks of development (from 2026-08-31 onward) for intensive submission preparation and defect remediation: executing the complete R1–R21 defect-batch remediation plan across 21 phases (Aug 31 – Sep 2), implementing subsystems shipped in that period (EntityCatalogue registry, dynamic lighting shader, real map editor with custom-level save/load, attract-mode idle replay, LOAD GAME menu with slot picker), fixing and completing Endless Mode with procedural boss arenas and the level-solvability oracle, writing and running the `verify_*` regression test suite (38 cases covering 504+ checks), and generating/expanding all submission documents (report, feature list, member contributions, testing checklist, AI usage declaration, demo video checklist) directly from codebase git logs and evidence trails rather than from blank pages.
